...
'''
        if message.channel.name == 'winners_2_1':
            ...
            if j == None:
                ...
                await client.send_message(message.channel, '敗北チームは #losers_final のチャットで待機してください')
            else:
        ...
        if message.channel.name == 'winners_2_2':
            ...
            if j == None:
                ...
                await client.send_message(message.channel, 'おめでとうございます。勝利チームは #winners_3_1 のチャットで待機してください')
                await client.send_message(message.channel, '敗者チームは #losers_2_2 のチャットで待機してください')
